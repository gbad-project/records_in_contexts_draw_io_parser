...
CONVERT_DESCRIPTION_SCRIPT="$ROOT_DIR/tests/scripts/linux/test_add.sh"

source "$CONVERT_DESCRIPTION_SCRIPT"

CONVERT_AUTHORITY_SCRIPT="$ROOT_DIR/tests/scripts/linux/test_auth.sh"

source "$CONVERT_AUTHORITY_SCRIPT"

LOG_FILE_MERGE="$ROOT_DIR/tests/logs/test_run.log"

MERGED_GRAPH="$ROOT_DIR/tests/data/store.nq"
