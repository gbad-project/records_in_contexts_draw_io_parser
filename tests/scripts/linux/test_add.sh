...
LOG_FILE_2="$ROOT_DIR/tests/logs/test_map_rml_add_description_tailshuf_100.log"

COMMAND_2="python $ROOT_DIR/map_rml.py add tests/test_description_tailshuf_100/"
